...
## 59. EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
## 65. SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
## 66. AG$^2$aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
## 67. Robust and Efficient 3D Gaussian Splatting for Urban Scene Reconstruction
...
## 68. GaRe: Relightable 3D Gaussian Splatting for Outdoor Scenes from Unconstrained Photo Collections
...
## 69. Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
## 70. Taking Language Embedded 3D Gaussian Splatting into the Wild
...
## 71. LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
## 72. GCC: A 3DGS Inference Architecture with Gaussian-Wise and Cross-Stage Conditional Processing
...
## 73. Adaptive 3D Gaussian Splatting Video Streaming
...
## 74. A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
## 75. SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
## 86. Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
## 87. TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
## 88. SpeeDe3DGS: Speedy Deformable 3D Gaussian Splatting with Temporal Pruning and Motion Grouping
...
## 89. DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
## 90. Multi-Spectral Gaussian Splatting with Neural Color Representation
...
## 91. GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
## 92. CountingFruit: Language-Guided 3D Fruit Counting with Semantic Gaussian Splatting
...
## 93. Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
## 94. TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
## 95. Learning Hierarchical Sparse Transform Coding for 3DGS Compression
...
## 96. HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
## 97. VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
## 98. SplatCo: Structure-View Collaborative Gaussian Splatting for Detail-Preserving Rendering of Large-Scale Unbounded Scenes
...
## 99. R3GS: Gaussian Splatting for Robust Reconstruction and Relocalization in Unconstrained Image Collections
...
## 100. A Novel Benchmark and Dataset for Efficient 3D Gaussian Splatting with Gaussian Point Cloud Compression
...
## 101. EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
...
## 102. ControlGS: Consistent Structural Compression Control for Deployment-Aware Gaussian Splatting
...
## 103. Neural Video Compression using 2D Gaussian Splatting
...
## 104. ADC-GS: Anchor-Driven Deformable and Compressed Gaussian Splatting for Dynamic Scene Reconstruction
...
## 105. Virtualized 3D Gaussians: Flexible Cluster-based Level-of-Detail System for Real-Time Rendering of Composed Scenes
...
## 106. GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
## 107. 3D Gaussian Splatting Data Compression with Mixture of Priors
...
## 108. SignSplat: Rendering Sign Language via Gaussian Splatting
...
## 109. 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
## 110. 3D Gaussian Head Avatars with Expressive Dynamic Appearances by Compact Tensorial Representations
...
## 111. Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
## 112. CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
## 125. Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
## 126. CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
## 127. CompMarkGS: Robust Watermarking for Compressed 3D Gaussian Splatting
...
## 128. PCGS: Progressive Compression of 3D Gaussian Splatting
...
## 129. MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
## 130. Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
## 131. Progressively Deformable 2D Gaussian Splatting for Video Representation at Arbitrary Resolutions
...
## 132. EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
## 133. GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
## 134. GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
## 135. OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
## 136. LiteGS: A High-performance Framework to Train 3DGS in Subminutes via System and Algorithm Codesign
...
## 137. Compression in 3D Gaussian Splatting: A Survey of Methods, Trends, and Future Directions
...
## 138. Pointmap Association and Piecewise-Plane Constraint for Consistent and Compact 3D Gaussian Segmentation Field
...
## 139. Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
## 140. GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
## 141. DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
## 143. UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
## 144. CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
## 145. GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
## 146. GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
## 147. Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
## 148. GSVC: Efficient Video Representation and Compression Through 2D Gaussian Splatting
...
## 149. Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
## 150. GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
## 151. Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
## 152. 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
## 153. CLIP-GS: CLIP-Informed Gaussian Splatting for View-Consistent 3D Indoor Semantic Understanding
