...
## 2. Fast Converging 3D Gaussian Splatting for 1-Minute Reconstruction
...
## 4. AD-GS: Alternating Densification for Sparse-Input 3D Gaussian Splatting

- **作者**: Gurutva Patle, Nilay Girgaonkar, Nagabhushan Somraj, Rajiv Soundararajan
- **发布时间**: 2025-09-13
- **arXiv链接**: [arXiv:2509.11003v2](http://arxiv.org/abs/2509.11003v2)
...
## 5. AD-GS: Alternating Densification for Sparse-Input 3D Gaussian Splatting
...
## 6. AD-GS: Alternating Densification for Sparse-Input 3D Gaussian Splatting
