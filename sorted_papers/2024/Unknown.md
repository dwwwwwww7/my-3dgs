...
- **代码链接**: [GitHub](https://github.com/leon2000-ai/TSGaussian)
...
- **发布时间**: 2024-12-08
- **arXiv链接**: [arXiv:2412.05808v2](http://arxiv.org/abs/2412.05808v2)
...
- **发布时间**: 2024-11-26
- **arXiv链接**: [arXiv:2411.17605v3](http://arxiv.org/abs/2411.17605v3)
- **代码链接**: [GitHub](https://github.com/bbbbby-99/DGGS)
...
- **代码链接**: [GitHub](https://github.com/gmum/VeGaS)
...
- **代码链接**: [GitHub](https://github.com/Barrybarry-Smith/PixelGaussian)
...
- **代码链接**: [GitHub](https://github.com/YihangChen-ee/FCGS)
...
- **代码链接**: [GitHub](https://github.com/goldoak/GSFusion)
...
- **代码链接**: [GitHub](https://github.com/Qi-Yangsjtu/GGSC)
...
- **代码链接**: [GitHub](https://github.com/Xian-Bei/GaussianForest)
...
- **代码链接**: [GitHub](https://github.com/eriksandstroem/Splat-SLAM)
- **说明**: 21 pages
...
## 65. GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting

- **作者**: Bo Chen, Shoukang Hu, Qi Chen et al.
- **发布时间**: 2024-04-29
- **arXiv链接**: [arXiv:2404.19040v1](http://arxiv.org/abs/2404.19040v1)
...
## 66. EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
## 67. Application of 3D Gaussian Splatting for Cinematic Anatomy on Consumer Class Devices
...
## 68. 3D Gaussian Splatting as Markov Chain Monte Carlo
...
## 69. CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
## 70. Revising Densification in Gaussian Splatting
...
## 71. TOGS: Gaussian Splatting with Temporal Opacity Offset for Real-Time 4D DSA Rendering

- **作者**: Shuai Zhang, Huangxuan Zhao, Zhenghong Zhou et al.
- **发布时间**: 2024-03-28
- **arXiv链接**: [arXiv:2403.19586v2](http://arxiv.org/abs/2403.19586v2)
- **代码链接**: [GitHub](https://github.com/hustvl/TOGS)
...
## 72. Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
## 73. HAC: Hash-grid Assisted Context for 3D Gaussian Splatting Compression
...
- **代码链接**: [GitHub](https://github.com/YihangChen-ee/HAC)
...
## 74. Mini-Splatting: Representing Scenes with a Constrained Number of Gaussians

- **作者**: Guangchi Fang, Bing Wang
- **发布时间**: 2024-03-21
- **arXiv链接**: [arXiv:2403.14166v3](http://arxiv.org/abs/2403.14166v3)
- **代码链接**: [GitHub](https://github.com/fatPeter/mini-splatting)
...
## 75. NEDS-SLAM: A Neural Explicit Dense Semantic SLAM Framework using 3D Gaussian Splatting
...
- **发布时间**: 2024-03-13
- **arXiv链接**: [arXiv:2403.08498v2](http://arxiv.org/abs/2403.08498v2)
- **说明**: GCPR 2024
