...
## 11. Drop-In Perceptual Optimization for 3D Gaussian Splatting
...
- **发布时间**: 2026-03-17
- **arXiv链接**: [arXiv:2603.16103v3](https://arxiv.org/abs/2603.16103v3)
- **说明**: ECCV 2026
...
## 13. ReSplat: Learning Recurrent Gaussian Splatting

- **作者**: Haofei Xu, Daniel Barath, Andreas Geiger, Marc Pollefeys
- **发布时间**: 2025-10-09
- **arXiv链接**: [arXiv:2510.08575v4](https://arxiv.org/abs/2510.08575v4)
- **说明**: ECCV 2026, Spotlight. Project page: https://haofeixu.github.io/resplat/ Code: https://github.com/cvg/resplat
...
## 14. HandSCS: Structural Coordinate Space for Animatable Hand Gaussian Splatting
