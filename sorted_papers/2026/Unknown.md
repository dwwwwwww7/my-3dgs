...
## 4. HarmoGS: Robust 3D Gaussian Splatting in the Wild via Conflict-Aware Gradient Harmonization

- **作者**: Yulei Kang, Tianze Zhu, Jian-Fang Hu, Jianhuang Lai, Wei-Shi Zheng
- **发布时间**: 2026-05-13
- **arXiv链接**: [arXiv:2605.13073v1](http://arxiv.org/abs/2605.13073v1)
...
## 5. 3DGS$^3$: Joint Super Sampling and Frame Interpolation for Real-Time Large-Scale 3DGS Rendering
...
## 7. MAGS-SLAM: Monocular Multi-Agent Gaussian Splatting SLAM for Geometrically and Photometrically Consistent Reconstruction
...
## 8. Disambiguating 2D-3D Correspondences in Gaussian Splatting-based Feature Fields for Visual Localization
...
- **发布时间**: 2026-05-05
- **arXiv链接**: [arXiv:2605.04035v2](http://arxiv.org/abs/2605.04035v2)
...
## 10. GETA-3DGS: Automatic Joint Structured Pruning and Quantization for 3D Gaussian Splatting
...
## 11. 2D-SuGaR: Surface-Aware Gaussian Splatting for Geometrically Accurate Mesh Reconstruction
...
## 12. MesonGS++: Post-training Compression of 3D Gaussian Splatting with Hyperparameter Searching
...
## 13. Generalizable 3D Gaussian Splatting enabled Semantic Coding for Real-Time Immersive Video Communications
...
## 14. Gaussians on a Diet: High-Quality Memory-Bounded 3D Gaussian Splatting Training
...
## 15. OT-UVGS: Revisiting UV Mapping for Gaussian Splatting as a Capacity Allocation Problem
...
## 16. Incoherent Deformation, Not Capacity: Diagnosing and Mitigating Overfitting in Dynamic Gaussian Splatting
...
## 17. Splats in Splats++: Robust and Generalizable 3D Gaussian Splatting Steganography
...
## 18. GaussianFlow SLAM: Monocular Gaussian Splatting SLAM Guided by GaussianFlow
...
## 19. GlobalSplat: Efficient Feed-Forward 3D Gaussian Splatting via Global Scene Tokens
...
## 20. Unfolding 3D Gaussian Splatting via Iterative Gaussian Synopsis
...
## 21. GS4City: Hierarchical Semantic Gaussian Splatting via City-Model Priors
...
## 22. Naka-GS: A Bionics-inspired Dual-Branch Naka Correction and Progressive Point Pruning for Low-Light 3DGS
...
## 23. A 129FPS Full HD Real-Time Accelerator for 3D Gaussian Splatting
...
## 24. DOC-GS: Dual-Domain Observation and Calibration for Reliable Sparse-View Gaussian Splatting
...
## 25. GaussFly: Contrastive Reinforcement Learning for Visuomotor Policies in 3D Gaussian Fields
...
## 26. Flash-Mono: Feed-Forward Accelerated Gaussian Splatting Monocular SLAM
...
## 27. SparseSplat: Towards Applicable Feed-Forward 3D Gaussian Splatting with Pixel-Unaligned Prediction
...
## 28. GS^2: Graph-based Spatial Distribution Optimization for Compact 3D Gaussian Splatting
...
## 29. FaCT-GS: Fast and Scalable CT Reconstruction with Gaussian Splatting
...
## 30. Autoregressive Appearance Prediction for 3D Gaussian Avatars
...
## 31. Compact Keyframe-Optimized Multi-Agent Gaussian Splatting SLAM
...
## 32. Gleanmer: A 6 mW SoC for Real-Time 3D Gaussian Occupancy Mapping
...
## 33. LG-HCC: Local Geometry-Aware Hierarchical Context Compression for 3D Gaussian Splatting
...
## 34. GaussianGPT: Towards Autoregressive 3D Gaussian Scene Generation

- **作者**: Nicolas von Lützow, Barbara Rössle, Katharina Schmid, Matthias Nießner
- **发布时间**: 2026-03-27
- **arXiv链接**: [arXiv:2603.26661v1](http://arxiv.org/abs/2603.26661v1)
...
## 35. FilterGS: Traversal-Free Parallel Filtering and Adaptive Shrinking for Large-Scale LoD 3D Gaussian Splatting
...
## 36. Drop-In Perceptual Optimization for 3D Gaussian Splatting
...
## 37. Camera-Agnostic Pruning of 3D Gaussian Splats via Descriptor-Based Beta Evidence
...
## 39. Matryoshka Gaussian Splatting
...
## 40. NanoGS: Training-Free Gaussian Splat Simplification
...
## 41. Direct Object-Level Reconstruction via Probabilistic Gaussian Splatting
...
## 42. Spectral Defense Against Resource-Targeting Attack in 3D Gaussian Splatting
...
## 45. GSStream: 3D Gaussian Splatting based Volumetric Scene Streaming System
...
## 46. ProGS: Towards Progressive Coding for 3D Gaussian Splatting
...
## 47. X-GS: An Extensible Open Framework for Perceiving and Thinking via 3D Gaussian Splatting
...
## 48. Improving Continual Learning for Gaussian Splatting based Environments Reconstruction on Commercial Off-the-Shelf Edge Devices
...
## 49. Multimodal-Prior-Guided Importance Sampling for Hierarchical Gaussian Splatting in Sparse-View Novel View Synthesis
...
## 50. HeroGS: Hierarchical Guidance for Robust 3D Gaussian Splatting under Sparse Views
...
## 54. GaussianPOP: Principled Simplification Framework for Compact 3D Gaussian Splatting via Error Quantification
...
## 55. Nix and Fix: Targeting 1000x Compression of 3D Gaussian Splatting with Diffusion Models
...
## 56. Constrained Dynamic Gaussian Splatting
...
## 57. WebSplatter: Enabling Cross-Device Efficient Gaussian Splatting in Web Browsers via WebGPU
...
## 58. SharpTimeGS: Sharp and Stable Dynamic Gaussian Splatting via Lifespan Modulation
...
## 59. HPC: Hierarchical Point-based Latent Representation for Streaming Dynamic Gaussian Splatting Compression
...
## 60. LangGS-SLAM: Real-Time Language-Feature Gaussian Splatting SLAM
...
## 61. LoD-Structured 3D Gaussian Splatting for Streaming Video Reconstruction
...
## 62. PocketGS: On-Device Training of 3D Gaussian Splatting for High Perceptual Modeling

- **作者**: Wenzhi Guo, Guangchi Fang, Shu Yang, Bing Wang
- **发布时间**: 2026-01-24
- **arXiv链接**: [arXiv:2601.17354v4](http://arxiv.org/abs/2601.17354v4)
...
## 63. LL-GaussianImage: Efficient Image Representation for Zero-shot Low-Light Enhancement with 2D Gaussian Splatting
...
## 64. POTR: Post-Training 3DGS Compression
...
## 65. Structured Image-based Coding for Efficient Gaussian Splatting Compression
...
## 66. TIDI-GS: Floater Suppression in 3D Gaussian Splatting for Enhanced Indoor Scene Fidelity
...
## 67. Sketch&Patch++: Efficient Structure-Aware 3D Gaussian Representation
...
## 68. SCAR-GS: Spatial Context Attention for Residuals in Progressive Gaussian Splatting
...
## 69. Clean-GS: Semantic Mask-Guided Pruning for 3D Gaussian Splatting
...
## 70. Voxel-GS: Quantized Scaffold Gaussian Splatting Compression with Run-Length Coding
...
## 71. Lightweight 3D Gaussian Splatting Compression via Video Codec
