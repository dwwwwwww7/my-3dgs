...
- **发布时间**: 2026-03-19
- **arXiv链接**: [arXiv:2603.19234v1](https://arxiv.org/abs/2603.19234v1)
...
## 4. Spectral Defense Against Resource-Targeting Attack in 3D Gaussian Splatting
...
## 5. Mobile-GS: Real-time Gaussian Splatting for Mobile Devices
...
## 6. ReCoSplat: Autoregressive Feed-Forward Gaussian Splatting Using Render-and-Compare
...
## 7. GSStream: 3D Gaussian Splatting based Volumetric Scene Streaming System
...
## 8. ProGS: Towards Progressive Coding for 3D Gaussian Splatting
...
## 9. X-GS: An Extensible Open Framework for Perceiving and Thinking via 3D Gaussian Splatting
...
## 10. Improving Continual Learning for Gaussian Splatting based Environments Reconstruction on Commercial Off-the-Shelf Edge Devices
...
## 11. Multimodal-Prior-Guided Importance Sampling for Hierarchical Gaussian Splatting in Sparse-View Novel View Synthesis
...
## 12. HeroGS: Hierarchical Guidance for Robust 3D Gaussian Splatting under Sparse Views
...
## 13. Semantic-Guided 3D Gaussian Splatting for Transient Object Removal
...
## 14. CompSplat: Compression-aware 3D Gaussian Splatting for Real-world Video
...
## 15. Forecasting as Rendering: A 2D Gaussian Splatting Framework for Time Series Forecasting
...
## 16. GaussianPOP: Principled Simplification Framework for Compact 3D Gaussian Splatting via Error Quantification
...
## 17. Nix and Fix: Targeting 1000x Compression of 3D Gaussian Splatting with Diffusion Models
...
## 18. Constrained Dynamic Gaussian Splatting
...
## 19. WebSplatter: Enabling Cross-Device Efficient Gaussian Splatting in Web Browsers via WebGPU
...
## 20. SharpTimeGS: Sharp and Stable Dynamic Gaussian Splatting via Lifespan Modulation
...
## 21. HPC: Hierarchical Point-based Latent Representation for Streaming Dynamic Gaussian Splatting Compression
...
## 22. LangGS-SLAM: Real-Time Language-Feature Gaussian Splatting SLAM
...
## 23. LoD-Structured 3D Gaussian Splatting for Streaming Video Reconstruction
...
## 24. PocketGS: On-Device Training of 3D Gaussian Splatting for High Perceptual Modeling
...
## 25. LL-GaussianImage: Efficient Image Representation for Zero-shot Low-Light Enhancement with 2D Gaussian Splatting
...
## 26. POTR: Post-Training 3DGS Compression
...
## 28. TIDI-GS: Floater Suppression in 3D Gaussian Splatting for Enhanced Indoor Scene Fidelity
...
## 29. Sketch&Patch++: Efficient Structure-Aware 3D Gaussian Representation
...
## 30. SCAR-GS: Spatial Context Attention for Residuals in Progressive Gaussian Splatting
...
## 31. Clean-GS: Semantic Mask-Guided Pruning for 3D Gaussian Splatting
...
## 32. Voxel-GS: Quantized Scaffold Gaussian Splatting Compression with Run-Length Coding
...
## 33. Lightweight 3D Gaussian Splatting Compression via Video Codec
...
## 34. SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting
