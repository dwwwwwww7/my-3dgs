...
- **发布时间**: 2026-08-08
- **arXiv链接**: [arXiv:2608.07937v1](http://arxiv.org/abs/2608.07937v1)
...
## 3. FlexSplat: Flexible Feed-Forward 3D Gaussian Splatting without Point Cloud Correspondence
...
## 4. Camera-Agnostic Pruning of 3D Gaussian Splats via Descriptor-Based Beta Evidence

- **作者**: Peter Fasogbon, Ugurcan Budak, Patrice Rondao Alface, Hamed Rezazadegan Tavakoli
- **发布时间**: 2026-03-23
- **arXiv链接**: [arXiv:2603.21933v3](http://arxiv.org/abs/2603.21933v3)
